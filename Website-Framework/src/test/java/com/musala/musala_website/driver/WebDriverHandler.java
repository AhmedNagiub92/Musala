package com.musala.musala_website.driver;
...
public class WebDriverHandler {
    ...
    private static final String edgeDriverPath = "../driverBinaries/msedgedriver";
    ...
    private static String safariDriverType = "webdriver.safari.driver";

    private static String browserType = "../Website-Framework/resources/config/configBrowser.properties";
